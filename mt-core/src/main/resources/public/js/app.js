(function () {
    ...
    app.config(function ($stateProvider, $urlRouterProvider, $controllerProvider) {
            ...
            $stateProvider.state('home', {
                ...
                url: '/ships/new',
                templateUrl: viewsPrefix + 'ship-add.html',
                controller: 'ShipCreateController'
            }).state('ships', {
                url: '/ships',
                templateUrl: viewsPrefix + 'ships.html',
                controller: 'ShipListController',
                data: {
                    pageTitle: 'Ships meta data'
                }
            }).state('seaports', {
                url: '/seaports',
                templateUrl: viewsPrefix + 'seaports.html',
                controller: 'SeaportController',
                data: {
                    pageTitle: 'Seaports'
                }
            }).state('newSeaport', {
                url: '/seaports/new',
                templateUrl: viewsPrefix + 'seaport-add.html',
                controller: 'SeaportCreateController'
            }).state('Map', {
                url: '/map',
                templateUrl: viewsPrefix + 'map.html',
