...
public class SolutionController {
    ...
    @Autowired
    public SolutionController(ProblemResolver resolver, ForecastDataAdapterFactory adapterFactory1) {
    ...
    public ResponseEntity solve(@RequestBody AlgorithmInputData algorithmInputData,
        ...
        final ZonedDateTime plannedDepartureDateTime = algorithmInputData.getPlannedDepartureDateTime();
        ...
        if (plannedDepartureDateTime != null) {
            ...
            LOG.info("Departure date not provided, current date time will be used - {}", departureDateTime);
        }
        ...
        try {
            ...
            String errorMessage = String.format("Forecast for %s not available", departureDateTime.toString());
